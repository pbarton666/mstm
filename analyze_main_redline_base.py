#analyze_main.py
#
#Uses input data and file locations specified in mappings_redline_base.py
#
...
#  input files, and other settings are specified in the input file (also identified in mappings_redline_base.py)
...
from mappings_redline_base import *  #constants for file locations, run-time settings, database name, etc.
import logger_setup
